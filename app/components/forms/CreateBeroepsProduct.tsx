...
import {createBeroepsproduct, CreateBeroepsproductDTO} from "../../lib/api/beroepsproducten";
                ...
                <Card sx={style}>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit}>
                            <Stack spacing={2}>
                                <TextField id="outlined-basic" name={"title"} label="Title" variant="outlined" fullWidth onChange={handleChange} />
                                <Grid2 container spacing={2}>
                                    ...
                                    <Grid2 size={2}>
                                        <TextField type="number" slotProps={{htmlInput:{min: 1, max: 4}}} defaultValue={1} name={"level"} label="Level" variant="outlined" fullWidth onChange={handleChange} />
                                    </Grid2>
                                    <Grid2 size={2}>
                                        <TextField id="outlined-basic" name={"guild"} label="Guild" variant="outlined" fullWidth onChange={handleChange} />
                                    </Grid2>
                                </Grid2>
