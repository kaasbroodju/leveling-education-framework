...
use crate::components::icons::{
	CategoryIcon, FaceIcon, OpenInNewIcon, Package2Icon, SchoolIcon, WebIcon, WorkIcon,
};
			...
			<AboutCard>
				<div class={scoped_css!("references.css")}>
					...
					<div>
						<ul>
							<li>
								<a href="/api/v2/vaardigheden" target="_blank"><span><FaceIcon /></span><span>{"Vaardigheden"}</span></a>
							</li>
							<li>
								<a href="/api/v1/beroepsrollen" target="_blank"><span><WorkIcon /></span><span>{"Beroepsrollen"}</span></a>
							</li>
							<li>
